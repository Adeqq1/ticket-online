...
<div id="panel-terms" role="tabpanel" aria-labelledby="tab-terms" hidden={active !== "terms"}><h2>Syarat & ketentuan</h2><ul class="terms-list"><li>Tiket contoh ini tidak dapat digunakan untuk masuk ke event.</li><li>Satu tiket berlaku untuk satu pengunjung.</li><li>Pengunjung wajib membawa identitas yang sesuai.</li></ul></div>
