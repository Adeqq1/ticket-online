...
if (typeof document !== "undefined") {
  ...
  if (!concert) {
    ...
    const quantities = parseQuantities(concert, new URLSearchParams(location.search));
    let state: DetailState = { ...initialState, selectedZoneId: Object.keys(quantities)[0] ?? null, quantities };
